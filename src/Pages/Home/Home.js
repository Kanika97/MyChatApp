            ...
            <div class="content-wrapper">
                ...
                <div class="AppfeaturesFounder">
                    <div class="1-box-lrg is-center pure-u-1 pure-u-md-1-2 pure-u-lg-2-5">
                        <br/>
                        <img width="300" alt="File Icons" class="pure-img-responsive" src={images.kanika}/>
                    </div>
                    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
                        <h2 class="content-head content-head-ribbon">Kanika Agrawal</h2>
                        <p style={{color:'white'}}>
                            USICT DELHI
                        </p>
                        <p style={{color:'white'}}>
                            Currently doing mca from usict delhi....
                        </p>
                    </div>
                </div>
            <Footer/>
